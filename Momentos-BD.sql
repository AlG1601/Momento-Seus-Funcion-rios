...
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (1,'Penelope','Wayne','Child',200);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (2,'Nick','Higgins','Child',205);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (3,'Ed','Whalen','Child',200);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (4,'Alice','Wayne','Child',100);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (5,'Johnny','Kochhar','Child',101);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (6,'Bette',"T'Challa",'Child',102);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (7,'Grace','Faviet','Child',109);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (8,'Matthew','Chen','Child',110);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (9,'Joe','Sciarra','Child',111);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (10,'Christian','Urman','Child',112);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (11,'Zero','Popp','Child',113);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (12,'John','Constantine','Child',108);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (13,'Duas','Mavris','Child',203);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (14,'Vivien','Hunold','Child',103);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (15,'Cuba','Ernst','Child',104);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (16,'Fred','Austin','Child',105);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (17,'Helen','Stark','Child',106);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (18,'Dan','Lorentz','Child',107);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (19,'Bob','Braddock ','Child',201);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (20,'Lucie','Ferreira','Child',202);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (21,'Kirsten','Baer','Child',204);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (22,'Harry','Osborn','Child',115);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (23,'Sandra','Baida','Child',116);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (24,'Cameron','Tobias','Child',117);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (25,'Kevin','Himuro','Child',118);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (26,'Rip','Colmenares','Child',119);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (27,'Julia','Raphaely','Child',114);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (28,'Woody','Russell','Child',145);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (29,'Alec','Partners','Child',146);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (30,'Sandra','Taylor','Child',176);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (31,'Franklin','Storm','Child',206);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (32,'Valeria','Storm','Child',206);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (33,'Reed','Storm','Partner',206);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (34,'Uma','Mavris','Partner',203);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (35,'Salvadora','Ernst','Partner',104);
INSERT INTO dependentes(dependente_id,primeiro_nome,sobrenome,relacionamento,funcionario_id) VALUES (36,'Jennifer','Wayne','Partner',100);
